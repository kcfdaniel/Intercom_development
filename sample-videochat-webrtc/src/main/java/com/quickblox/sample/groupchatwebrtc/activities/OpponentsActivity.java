...
public class OpponentsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //
        String myurl = "file:///android_asset/intercom/intercom/floor1.html";
...
//        view.getSettings().setDomStorageEnabled(true);
    ...
    public class WebAppInterface {
        ...
        public void checkRoom(String roomID) {
            Log.d("Creation", "POS passRoomID" + roomID);

            Integer _roomID = new Integer(roomID);

            OpponentsActivity.this.checkListViewItem(_roomID-1);

        }
    }

    void checkListViewItem (Integer roomID) {
//        opponentsListView.performItemClick(
//                opponentsListView.getAdapter().getView(roomID, null, null),
//                roomID,
//                opponentsListView.getItemIdAtPosition(roomID));

        opponentsAdapter.toggleSelection(roomID);

        updateActionBar(opponentsAdapter.getSelectedItems().size());

        Log.d("Creation", "POS user1 checked " + opponentsAdapter.getSelectedItems().size());
